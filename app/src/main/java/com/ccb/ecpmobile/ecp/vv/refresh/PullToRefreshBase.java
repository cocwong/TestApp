...
import com.ccb.ecpmobile.ecp.vv.refresh.internal.CustomLoadingLayout;
import com.ccb.ecpmobile.ecp.vv.refresh.internal.LoadingLayout;
import com.ccb.ecpmobile.ecp.vv.refresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final boolean isPullToRefreshOverScrollEnabled() {
        return mOverScrollEnabled && (mRefreshableView.getOverScrollMode() != View.OVER_SCROLL_NEVER);
    }
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection) {
            switch (this) {
                case ROTATE:
                default:
                    return new CustomLoadingLayout(context, mode, scrollDirection);
                case FLIP:
                    return new CustomLoadingLayout(context, mode, scrollDirection);
//					return new FlipLoadingLayout(context, mode, scrollDirection, attrs);
    ...
    public static enum Mode {
         ...
         * {@link com.ccb.ecpmobile.ecp.view.refresh.PullToRefreshBase#setRefreshing() setRefreshing()}.
         */
