...
import com.ccb.ecpmobile.ecp.vv.refresh.HeaderProgressView;
import com.ccb.ecpmobile.ecp.vv.refresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    protected HeaderProgressView headerProgressView;
    ...
    public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection) {
        ...
        headerProgressView = (HeaderProgressView) mInnerLayout.findViewById(R.id.header_progress_view);
